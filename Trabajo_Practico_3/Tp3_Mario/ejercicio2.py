...
# pesos: pesos (W y b)
def train(x, t, pesos, learning_rate, epochs, cantidad_clases, cant_test=500):
    ...
    # Ejercicio 2.b
    x_test,t_test=generar_datos_clasificacion(cant_test, cantidad_clases)
...
def iniciar(numero_clases, numero_ejemplos, graficar_datos):
    ...
    if graficar_datos:
        ...
        #plt.show()
        path_img = "graficos/" + 'Ejercicio2' +'.png'
